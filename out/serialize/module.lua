...
local SerializeTerrainDeclaration = TS.import(script, script.Parent, "type", "terrain").SerializeTerrainDeclaration
local serializers = { SerializeAttachmentDeclaration, SerializeClassDeclaration, SerializeMetadataDeclaration, SerializeInstanceDeclaration, SerializeMapDeclaration, SerializeScriptDeclaration, SerializeLightingPresetDeclaration, SerializeTerrainDeclaration }
